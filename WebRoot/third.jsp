...
<html>
	...
	<head>
		...
		<!--<script language="javascript">
			...
			var systemtime = 1530928984437;
			var d_system_client_time = systemtime - new Date().getTime();
			var trackConfig = {
				'guid': '15307971908871060088',
				'ip': '182.104.94.230',
				'accountid': '132447762',
				'refpage': '',
				'refdomain': '',
				'domain': 'i.51job.com',
				'pageName': 'resume_preview.php',
				'partner': 'baidupz',
				'islanding': '0',
			};
		...
		<script language="javascript" src="//js.51jobcdn.com/in/js/2016/resume/export.js?20180319"></script>-->
	</head>

	<body>
		<table border="0" cellpadding="0" cellspacing="0" align="center" class="chead" class="top">
			<tbody>
				<tr>
					<!--<td class="logo">
						<a href="//www.51job.com/default.php" class="logo"><img src="//img04.51jobcdn.com/im/2016/logo.png" alt="logo" width="110" height="45" /></a>
					</td>-->
					<td align="right" class="txt">
						<!--<img src="//img04.51jobcdn.com/im/2016/resume/print.png" align="absmiddle">
						<a class="blue" href="javascript:window.print();">打印</a>-->
					</td>
					<td align="right" class="txt">
						<!--<img src="//img04.51jobcdn.com/im/2016/resume/export.png" align="absmiddle">
						<a class="blue" href="javascript:cv_export('c','//i.51job.com/resume','367246668');">导出</a>-->
					</td>
				</tr>
			</tbody>
		</table>
									...
									<tr>
										...
										<td>
											<table cellspacing="0" cellpadding="0" border="0" class="infr">
												<tbody>
													<tr>
														<td colspan="2" class="name">XXX</td>
														<td align="right" class="icard">
															<a href="second.jsp" style="color: white; font-size: 15px; font-weight: 1000;">返回上一页</a><!--ID:367246668--></td>
													...
													<tr>
														...
														<td valign="top">
															<img class="vam" src="http://img01.51jobcdn.com/im/2016/resume/y2.png" width="20" height="20">181XXXX3256</td>
														<td valign="top">
															<table cellspacing="0" cellpadding="0" border="0" class="email">
																<tbody>
																	<tr>
																		...
																		<td valign="top" class="txt4">XXXXXX@qq.com</td>
																	</tr>
																</tbody>
															</table>
														</td>
													...
													<tr>
														<td valign="top" colspan="3">
															<p><img class="vam" src="http://img01.51jobcdn.com/im/2016/resume/y4.png" width="20" height="20">男<span class="p5">|</span>20 岁 (XXXX/05/14)<span class="p5">|</span>现居住南昌<span class="p5">|</span>1年工作经验
															</p>
														</td>
													</tr>
												</tbody>
															...
															<table cellspacing="0" cellpadding="0" border="0">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td valign="top" class="txt2">软件工程</td>
																	</tr>
																	<tr>
																		<td valign="top" class="keys">学校：</td>
																		<td valign="top" class="txt2">江西财经大学</td>
																	</tr>
																	<tr>
															...
															<table cellspacing="0" cellpadding="0" border="0">
																<tbody>
																	<tr>
																		...
																		<td valign="top" class="txt2">南昌</td>
																	</tr>
																</tbody>
															</table>
														</td>
															...
															<table cellspacing="0" cellpadding="0" border="0">
																<tbody>
																	<tr>
																		...
																		<td valign="top" class="txt2">8000-9999 元/月
																		</td>
																	</tr>
																</tbody>
															</table>
															...
															<table cellspacing="0" cellpadding="0" border="0">
																<tbody>
																	<tr>
																		...
																		<td valign="top" class="txt2"><span class="tag">江西省</span></td>
																	</tr>
																</tbody>
															</table>
														</td>
...
&nbsp;&nbsp;</span><span class="tag">算法工程师
&nbsp;&nbsp;</span><span class="tag">游戏策划师
</span>
																		</td>
																	</tr>
																</tbody>
															...
															<table cellspacing="0" cellpadding="0" border="0">
																<tbody>
																	<tr>
																		<td valign="top" class="keys">行业：</td>
																		<td valign="top" class="txt2">
																			<span class="tag">互联网/电子商务&nbsp;&nbsp;</span><span class="tag">计算机硬件&nbsp;&nbsp;</span><span class="tag">网络游戏</span>
																		</td>
																	</tr>
																</tbody>
															</table>
												...
												<tr>
													<td class="p15">
														<table cellspacing="0" cellpadding="0" border="0">
															<tbody>
																<tr>
																	<td valign="top" class="time">2016/9-2020/7</td>
																	<td valign="top" class="rtbox"><strong>江西财经大学</strong></td>
																</tr>
																<tr>
																	<td class="tb1" colspan="2">本科<span class="p5">|</span>软件工程</td>
																</tr>
															</tbody>
														</table>
													</td>
