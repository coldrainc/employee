...
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{if(typeof exports==="object"){factory(require("jquery"))}else{factory(jQuery)}}}(function($){var pluses=/\+/g;function encode(s){return config.raw?s:encodeURIComponent(s)}function decode(s){return config.raw?s:decodeURIComponent(s)}function stringifyCookieValue(value){return encode(config.json?JSON.stringify(value):String(value))}function parseCookieValue(s){if(s.indexOf('"')===0){s=s.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\")}try{s=decodeURIComponent(s.replace(pluses," "));return config.json?JSON.parse(s):s}catch(e){}}function read(s,converter){var value=config.raw?s:parseCookieValue(s);return $.isFunction(converter)?converter(value):value}var config=$.cookie=function(key,value,options){if(value!==undefined&&!$.isFunction(value)){options=$.extend({},config.defaults,options);if(typeof options.expires==="number"){var days=options.expires,t=options.expires=new Date();t.setTime(+t+days*86400000)}return(document.cookie=[encode(key),"=",stringifyCookieValue(value),options.expires?"; expires="+options.expires.toUTCString():"",options.path?"; path="+options.path:"",options.domain?"; domain="+options.domain:"",options.secure?"; secure":""].join(""))}var result=key?undefined:{};var cookies=document.cookie?document.cookie.split("; "):[];for(var i=0,l=cookies.length;i<l;i++){var parts=cookies[i].split("=");var name=decode(parts.shift());var cookie=parts.join("=");if(key&&key===name){result=read(cookie,value);break}if(!key&&(cookie=read(cookie))!==undefined){result[name]=cookie}}return result};config.defaults={};$.removeCookie=function(key,options){if($.cookie(key)===undefined){return false}$.cookie(key,"",$.extend({},options,{expires:-1}));return !$.cookie(key)}}));(function($, global, _doc) {
    $.extend($, {
        ...
        /*
         *  è¯´æ˜Žï¼šè¿‡æ»¤XSS
         *  @param  {String}    str éœ€è¦è¿‡æ»¤çš„å†…å®¹
         *  @return {String}    æ˜¾ç¤ºçš„å†…å®¹
         */
        xss: function(str) {
        ...
        /**
         * èŽ·å–urlæˆ–è€…è‡ªå®šä¹‰å­—ç¬¦ä¸²ä¸­çš„å‚æ•°
         *
         * @param {String} name ä¸ä¼ nameåˆ™ç›´æŽ¥è¿”å›žæ•´ä¸ªå‚æ•°å¯¹è±¡
         * @param {String} queryStr è‡ªå®šä¹‰å­—ç¬¦ä¸²
         * @param {Boolean} [unfilter:false] ä¸è¿›è¡Œå‚æ•°XSSå®‰å…¨è¿‡æ»¤
         * @param {Boolean} [undecode:false]] ä¸è¿›è¡Œè‡ªåŠ¨è§£ç 
         * @return {String|Object} èŽ·å–åˆ°çš„å‚æ•°å€¼æˆ–è€…ç”±æ‰€æœ‰å‚æ•°ç»„æˆå®Œæ•´å¯¹è±¡
         */
        ...
        /**
         * ç»Ÿä¸€ç»™urlæ·»åŠ å‚æ•°ï¼Œå¦‚æžœurlä¸­å­˜åœ¨ï¼Œåˆ™ä¼šè‡ªåŠ¨æ·»åŠ tokenå‚æ•°
         * @param  {String} str è¦è·³è½¬åˆ°çš„urlé“¾æŽ¥
         * @param  {JSON}   paramMap ä¸€äº›é™„åŠ å‚æ•°
         * @param  {String} æ‹¼æŽ¥åŽçš„urlé“¾æŽ¥
         */
        ...
        /**
         * å°†å‚æ•°å½¢å¼å­—ç¬¦ä¸²è½¬ä¸ºjsonæ ¼å¼
         * @param  {String} str ç±»ä¼¼äºŽ:a=12&b=23&c=45
         * @param  {String} sep åˆ†éš”ç¬¦
         * @return {JSON} JSONå¯¹è±¡æ•°æ®
         */
        unparam: function(str, sep) {
            ...
            for (; i < len; i++) {
                ...
                // pair[1] å¯èƒ½åŒ…å«gbkç¼–ç ä¸­æ–‡, è€ŒdecodeURIComponent ä»…èƒ½å¤„ç†utf-8 ç¼–ç ä¸­æ–‡
                try {
    ...
    // window.nameç¼“å­˜ï¼Œå’ŒlocalStorageåŠsessionStorageè¡Œä¸ºä¿æŒä¸€è‡´
    var nameStore = {
        // åˆ·æ–°æ•°æ®
    ...
    /**
     * å­˜å‚¨æ”¯æŒ
     * @param  {String} type      å¯é€‰ï¼Œå­˜å‚¨ç±»åž‹ï¼šlocalã€sessionã€nameã€storageï¼Œé»˜è®¤session
     * @param  {String} nameSpace å¯é€‰ï¼Œå‘½åç©ºé—´ï¼Œé»˜è®¤ä½¿ç”¨'STORAGE_NAMESPACE'å‘½åç©ºé—´
     */
    var _Storage = function(type, nameSpace) {
        ...
        var
            MAX = 40, // æœ€å¤§å°è¯•æ¬¡æ•°
            COUNT = 0, // è®¡æ•°
            TIME = 1000 * 60 * 60 * 24, // ä¸€å¤©æ—¶é—´
            storageTpye = {
                local: function(key) {
                    return $.isLocalAble ? // localStorageå­˜å‚¨ï¼Œå¦‚æžœä¸æ”¯æŒè¯¥å­˜å‚¨æ–¹å¼ï¼Œè®¾ç½®æ— æ•ˆæžœï¼Œæ‰€ä»¥éœ€è¦å…ˆåˆ¤æ–­æ˜¯å¦æ”¯æŒlocalå­˜å‚¨
                        [$.parseJSON(localStorage.getItem(key) || "{}"), localStorage] : [{}, {setItem: function(){}}];
                },
                session: function(key) { // sessionçº§ç¼“å­˜ï¼ŒsessionStorage -> window.name é€æ­¥å…¼å®¹
                    return $.isSessionAble ?
                        [$.parseJSON(sessionStorage.getItem(key) || "{}"), sessionStorage] : this.name(key);
                },
                name: function(key) { // ä¹Ÿæ˜¯sessionçº§ç¼“å­˜ï¼Œä½†æ˜¯åªç”¨window.nameå­˜å‚¨
                    return [nameStore.getItem(key), nameStore];
                },
                storage: function(key) { // localStorage -> sessionStorage -> window.name é€æ­¥å…¼å®¹
                    return $.isLocalAble ?
        ...
        storageData = temp[0]; // å­˜å‚¨æ•°æ®
        storage = temp[1]; // å­˜å‚¨æ–¹å¼

        /**
         * è®¾ç½®å­˜å‚¨æ•°æ®
         * @param {[type]} key   é”®å
         * @param {[type]} value é”®å€¼
         */
        ...
        /**
         * å–å¾—æ•´æ®µæ•°æ®
         * @param  {Boolean} extend ï¼Œæœ€å¥½ä¼ å…¥è¯¥å‚æ•°ä¸ºtrueï¼Œé˜²æ­¢å¯¹è¿”å›žçš„æ•°æ®æ›´æ”¹
         */
        ...
        var _flush = function() {
            ...
            try {
                ...
                throw new Error('JSON.stringifyè½¬åŒ–å‡ºé”™');
            }
    ...
    //æš‚ä¸å¼€æ”¾ï¼Œé˜²æ­¢å†…å­˜å ç”¨åŠå¯èƒ½çš„æ•°æ®ä¸²æ‰°
    // $.nameS = storage('name');
