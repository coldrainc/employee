...
html {
	...
	<div id="login-block" style="position: relative;">
		<ul style="position: fixed; z-index: 3; left: -130px; transition: left 1s;">
    ...
    <section class="amz-sidebar am-offcanvas-bar">
        <ul class="am-nav">
            <li class="am-nav-header" style="font-weight: bolder; font-size: 2.0rem; ">就业政策</li>
                                </ul>
    </section>
    <div class="amz-pager">
    ...
    <div class="am-u-md-9" style="padding-bottom:20px;margin-top: 15px">
        <div><img src="img/141422229614.png" /></div>
        <ul class="am-list">
                        <li><a href="#" target="_blank">[2018-04-11] 江西省高等院校毕业生就业指导服务中心关于开通中国高等教育学历网上申请的通知（转省就业办通知） </a></li>
                        <li><a href="#" target="_blank">[2017-12-04] 毕业季之就业流程七 </a></li>
                        <li><a href="#" target="_blank">[2017-12-04] 毕业季之就业流程六 </a></li>
                        <li><a href="#" target="_blank">[2017-12-04] 毕业季之就业流程五 </a></li>
                        <li><a href="#" target="_blank">[2017-12-04] 毕业季之就业流程四 </a></li>
                        <li><a href="#" target="_blank">[2017-12-04] 毕业季之就业流程三 </a></li>
                        <li><a href="#" target="_blank">[2017-12-04] 毕业季之就业流程二 </a></li>
                        <li><a href="#" target="_blank">[2017-12-03] 毕业季之就业流程一 </a></li>
                    </ul>
