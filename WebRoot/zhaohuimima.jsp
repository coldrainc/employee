...
<script type="text/jscript">
    ...
    <div class="commonMain" style="margin: 30px 0 100px 0;">
	        <div class="ct">
    	        <div class="page-map">我的位置：忘记密码</div>
    	        <div class="fn-main border-top">
                    <!---->
                    <div class="registerList">
                        <div class="textTab">
                            <a href="javascript:void(0)" style=" cursor:text;" class="active">邮箱找回</a>
                            <div class="pos_r">
                                <a href="#">手机找回</a>
                            </div>
                        </div>
                        <div class="listUnit_p">
                            <div class="inpList clearfix" id="ctmName_div">
                                <div class="inpTitle fl">会&nbsp;&nbsp;员&nbsp;&nbsp;名</div>
                                <div class="inpRegion fl"><input name="ctmName" type="text" id="ctmName" code1="6" code2="9" autocomplete="off" maxlength="20" ph="请输入会员名" /></div>
                            </div>
                            <div class="inpList clearfix" id="userName_div">
                                <div class="inpTitle">用&nbsp;&nbsp;户&nbsp;&nbsp;名</div>
                                <div class="inpRegion"><input name="userName" type="text" id="userName" code1="7" code2="10" autocomplete="off" maxlength="80" ph="请输入用户名" /></div>
                            </div>
                            <div class="inpList clearfix" id="email_div">
                                <div class="inpTitle">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</div>
                                <div class="inpRegion"><input name="email" type="text" id="email" code1="8" code2="11" code3="12" autocomplete="off" maxlength="80" ph="请输入邮箱" /></div>
                            </div>
                        </div>
                        <!---->
                        <div class="box-center">
                            <a href="javascript:void(0)" id="findpwdsubmit" class="btn-blue-b" onclick="FindPwd.Doajaxsubmit()">提交</a>
                        </div>
                    </div>
                </div>
            </div>
